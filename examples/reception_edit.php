                        ...
                        <div class="col-md-10" >
                            <div class="card">
                                ...
                                <div class="card-content" >
                                    <form action="patient_entry_form.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <center> <a href="http://localhost/kdu_hospital/examples/patient_detail_form.php" class="button">Edit the patient record</a>
